...
// Import doctor illustration
import DoctorIllustration from './bot2.png';
...
const ChatbotInterface = () => {
  ...
  const handleSendMessage = (message) => {
    ...
    setTimeout(async () => {
      ...
      console.log(newBotMessage.data.response);
      const botResponse = {
        text: newBotMessage.data.response,
        sender: 'bot'
      }
    ...
    <>
      ...
      <AnimatePresence>
        {isOpen && chatOpen && (
          ...
          >
            <motion.div
              className={`fixed ${isExpanded ? 'inset-0 m-0' : 'bottom-4 right-4'} w-full ${isExpanded ? '' : 'max-w-md'} z-50`}
                ...
                <div className="p-4 border-t border-gray-200 bg-white">
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      className={`flex-1 py-5 px-4 pr-12 focus:outline-none text-sm relative z-10 transition-all duration-300 ${inputFocused
  ...
  <motion.button
    ...
    className={`p-2 rounded-full relative z-10 transition-all flex items-center justify-center ${
      deepSearch
      ...
      <AnimatePresence>
        {isOpen && !chatOpen && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 20 }}
            className="fixed z-40 w-[30rem] top-[75%] left-[80%] transform -translate-x-1/2 -translate-y-1/2"
          >
              ...
              <div className="relative max-w-2xl mx-auto">
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className={`w-full p-4 pr-16 focus:outline-none text-base relative z-10 transition-all ${inputFocused
                      ? 'bg-white/95 backdrop-blur-sm'
                      : 'bg-gray-100/90 hover:bg-gray-100'
                      }`}
                    style={{
